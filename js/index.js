...
$(function() {
	...
	var visite = $('#s_visite_guidee').offset().top;
	...
	$(window).on('scroll', function() {
		...
		} else if (y_scroll_pos >= menu && y_scroll_pos < visite) {
			highlight_menu($('.navigation a')[1]);
		} else if (y_scroll_pos >= visite && y_scroll_pos < nourriture_saine) {
